        ...
        <div key={index} className="relative mb-12">
          <div className="flex items-center justify-center">
            ...
            <div className="w-full flex items-center">
              ...
              <div className={`w-1/2 pr-8 text-right ${index % 2 === 0 ? 'flex justify-end' : 'hidden'}`}>
                {index % 2 === 0 && (
                  <Card className="w-full max-w-md">
                    ...
                    {item.tags && item.tags.length > 0 && (
                      <CardFooter className="flex flex-wrap gap-2 pb-4 px-6 justify-end">
                        {item.tags.map(tag => (
              ...
              <div className={`w-1/2 pl-8 ${index % 2 !== 0 ? 'flex justify-start' : 'hidden'}`}>
                {index % 2 !== 0 && (
                  <Card className="w-full max-w-md">
                      <CardHeader>
                          <p className="text-sm text-muted-foreground">{item.date}</p>

...
export const projects: Project[] = [
    ...
    title: 'Balloon Duel',
    category: 'Unity',
    description: 'Remaking the core gameplay of an old flash game I used to love when I was a kid.',
    imageUrl: "https://www.gazel.net/img/public/BalloonDuel.png",
    imageHint: "Balloon Duel Screenshot",
    technologies: ['Unity', 'C#'],
    longDescription: `<p>We spent long hours playing this game with my little brother. This felt like a good idea to train using unity by trying and recreate its core gameplay first.<br />More work iterations ongoing to add more of the features found in this <a href="https://www.newgrounds.com/portal/view/177120" target="_blank" rel="noopener noreferrer" style="color:#0c6e81;"> old flash game.</a></p>`,
  ...
  },
  {
    ...
    category: 'Web',
    description: 'Ready for use Symfony application to manage an animal shelter association.',
  ...
  },
  {
    ...
    category: 'Misc',
    description: 'Little QOL tool helping edit locked config files without hassle.',
    imageUrl: "https://www.gazel.net/img/public/LoLConfigEditor.png",
    imageHint: "Lol Config Editor Tool",
    technologies: ['C#', 'WPF'],
    longDescription: `<p>This tool was made to allow for easy edition of the Game.cfg and PersistedSettings.json files of the League of Legends game. Having these files locked makes it annoying to edit. This small project also helped me get a grasp of the basics of WPF when preparing interviews.</p>`,
    repoUrl: 'https://github.com/egazel/LoLConfigEditor'
  },
  {
    slug: 'arduino-windshield-hud',
    title: 'Arduino Windshield HUD',
    category: 'Misc',
